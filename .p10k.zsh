# Generated by Powerlevel10k configuration wizard on 2022-05-12 at 09:49 +07.
...
() {
  ...
  function prompt_sus() {
	p10k segment -b 2 -t "%(?:%{$FG[045]%}♥ %{$FG[211]%}♥ %{$FG[015]%}♥ %{$FG[211]%}♥ %{$FG[045]%}♥ :%{$FG[045]%}♡ %{$FG[211]%}♡ %{$FG[015]%}♡ %{$FG[211]%}♡ %{$FG[045]%}♡ )"
  }
