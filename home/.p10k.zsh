# Generated by Powerlevel10k configuration wizard on 2022-03-25 at 00:29 EDT.
...
() {
  ...
  function prompt_my_extra_icon() {
    p10k segment -b yellow -f red -i "%(?:%{$FG[045]%}♥ %{$FG[211]%}♥ %{$FG[015]%}♥ %{$FG[211]%}♥ %{$FG[045]%}♥ :%{$FG[045]%}♡ %{$FG[211]%}♡ %{$FG[015]%}♡ %{$FG[211]%}♡ %{$FG[045]%}♡ )"
  }
