...
# text color when inactive/not selected
inactivetextclr="#717e82"

# underline color when inactive/not selected
inactiveunderline="#02415c"

active_text_color=$textclr
active_bg=
active_underline=$underlineclr

inactive_text_color=$inactivetextclr
inactive_bg=
inactive_underline=$inactiveunderline
